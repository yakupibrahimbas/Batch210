...
public class CourseRunner {
    public static void main(String[] args) {
        ...
        //ODEV)Average score'u en yuksek olan kursun ismini console yazdiran kodu yaziniz.(limit ile cozunuz)
        //----------------------
        // 10) Kursta bulunan ogrenci sayilarina gore buyukten kucuge sirali bir sekilde listin
        // icinde  veren  kodu yaziniz.
       ...
       long ingilizceBolumSayisi= coursesList.stream().filter(t->t.getCourseName().contains("English")).count();
