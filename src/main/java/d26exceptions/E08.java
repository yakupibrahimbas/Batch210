...
public class E08 {
    public static void main(String[] args) throws IOException { //FileNotFoundException-child, IOException-parent
        /*
        ...
        //Herhangi bir sebeple Java, txt dosyasina ulasamazsak diye duzenleme yapmamizi istiyor.
        //iste bu duruma "compile time exception" denir. (FileNotFoundException)
